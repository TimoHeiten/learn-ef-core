    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationAssemblySteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StationAssemblySteps_AssemblySteps_AssemblyStepId",
                        column: x => x.AssemblyStepId,
                        principalTable: "AssemblySteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StationAssemblySteps_Stations_StationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StationAssemblySteps_AssemblyStepId",
                table: "StationAssemblySteps",
                column: "AssemblyStepId");

            migrationBuilder.CreateIndex(
                name: "IX_StationAssemblySteps_StationId",
                table: "StationAssemblySteps",
                column: "StationId");
